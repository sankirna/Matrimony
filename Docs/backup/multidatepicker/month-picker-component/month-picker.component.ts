...
export class MonthPickerComponent
  ...
  private _mode: 'SEMESTER' | 'MONTH' | 'MONTHYEAR' | undefined;
  @Input()
  get mode(): 'SEMESTER' | 'MONTH' | 'MONTHYEAR' | undefined{
    return this._mode;
  }
  ...
  _customFilter: ((d: Moment) => boolean) | undefined;
